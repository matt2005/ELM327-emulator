...
An internal dictionary (named *ObdMessage*) allows configuring the emulation, and can be easily configured to statically and dynamically update its dictionary to simulate OBDII answers produced by other vehicles.
...
After starting the program, the emulator is ready to use.(scenario = 'default')
...
- `'ISO14230'`: several OBD messages of CN6(China Nationwide Stage 6) EOL standard with ISO 14230
- `'ISO27145'`: several OBD messages of CN6(China Nationwide Stage 6) EOL standard with ISO 27145
- `'J1939'`: several OBD messages of CN6(China Nationwide Stage 6) EOL standard with SAE J1939
